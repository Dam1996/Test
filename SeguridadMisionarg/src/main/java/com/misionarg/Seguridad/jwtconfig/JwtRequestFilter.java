...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
        ...
        System.out.println("Ingresa a JwtRequestFilter") ;
        ...
        // El token JWT tiene el formato "token de portador". Elimina la palabra de portador y obtén
        // solo el Token
        if (requestTokenHeader != null && requestTokenHeader.startsWith("Bearer ")) {
            System.out.println("Ingreso el token Bearer") ;
        ...
        // Una vez que tengamos el token lo validemos.
